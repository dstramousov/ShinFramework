...
class Gtrwebsite_Answers_model extends SHIN_Model {

    /**
     * Physical tablename.
     */
    var $table_name = 'gtrwebsite_answers';
    ...
    function __construct()
    {
        ...
        // PK Index definition
        $this->primary_key   = 'idAnswer';

		// Index definition
//        $this->insert_index('idNode');
        $this->insert_index(array('idNode'=>'UNIQUE'));
        ...
        $this->insert_field(array(
            ...
            'null'              => 1,
            'info_field_ico'	=> 'images/help.png',
            'info_field_txt'	=> 'lang_label_gtrwebsite_answers_description',
...
//            'validate'  => 'validate_int'
        ...
        $this->insert_field(array(
            ...
            'null'		=> 1,
            'info_field_ico'	=> 'images/help.png',
            'info_field_txt'	=> 'lang_label_gtrwebsite_answers_datains',
        ));
        ...
        $this->insert_field(array(
            ...
            'null'		=> 1,
            'info_field_ico'	=> 'images/help.png',
            'info_field_txt'	=> 'lang_label_gtrwebsite_answers_datamod',
        ));
    ...
    * @sa SHIN_Model::save()
    ...
    function save($fields_to_save = null) {
        ...
        $fields_to_save = array('idNode', 'description', 'posX', 'posY', 'level', 'sort', 'idSolution');
    ...
    * @return array
    */
    function getAnswerByIdNode($idNode) {
        
                    SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->select('idAnswer');
                    ...
                    SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->select('sort');
		...
		if($result) {
			$result['img']  =   prep_url(SHIN_Core::$_config['core']['app_base_url'] . '/' . SHIN_Core::$_config['store']['answers_images'] . '/') . SHIN_Core::$_config['store']['thumbnails_prefix'] . $result['img'];
		}
    ...
    */
    function _uploadImg($name)
    {
        ...
        $base_image_path = SHIN_Core::$_config['core']['base_path'] . SHIN_Core::$_runned_application .DIRECTORY_SEPARATOR. SHIN_Core::$_config['store']['answers_images'] . DIRECTORY_SEPARATOR;
        
        SHIN_Core::$_libs['upload']->process_upload(SHIN_Core::$_config['store']['answers_images'], 'gtrwebsite_answers_img');
    ...
    */
    function _deleteOldImg($name = null) {
        if(!is_null($name)) {
            @unlink(SHIN_Core::$_config['core']['base_path'] . SHIN_Core::$_runned_application . DIRECTORY_SEPARATOR . SHIN_Core::$_config['store']['answers_images'] . DIRECTORY_SEPARATOR . $name);
        } else {
            @unlink(SHIN_Core::$_config['core']['base_path'] . SHIN_Core::$_runned_application . DIRECTORY_SEPARATOR . SHIN_Core::$_config['store']['answers_images'] . DIRECTORY_SEPARATOR . $this->img);    
        }
    }
    ...
    */
    function uploadImg(){
        // copy file to storer
        if($this->_is_uploaded('gtrwebsite_answers_img'))
        {            
            $this->_uploadImg($_FILES['gtrwebsite_answers_img']['name']);
        }
    }
    ...
    * @return null
    */
    function updateClicks($answerId) {
        
                    SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->select('clicks');
                    SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->from($this->table_name);
                    SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->where('idAnswer', $answerId);
        $query  =   SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->get();
        $result =   $query->row(0, 'array');
...
/* End of file Gtrwebsite_Answers_model.php */
