...
|
|	http://mywork/shinframework/gtrwebsite
|
*/
$config['core']['app_base_url']	= $config['core']['shinfw_base_url']."/gtrwebsite";
...
|
*/
$config['input']['uri_protocol']	= "REQUEST_URI";
...
|--------------------------------------------------------------------------
*/
$config['input']['default_form_input_info_processed'] = FALSE;

/*
|--------------------------------------------------------------------------
| Path where all images for news was stored
|--------------------------------------------------------------------------
*/
$config['store']['news_images'] = 'store'.DIRECTORY_SEPARATOR.'news';

/*
|--------------------------------------------------------------------------
| Path where all images for partners was stored
|--------------------------------------------------------------------------
*/
$config['store']['partners_images'] = 'store'.DIRECTORY_SEPARATOR.'partners';

/*
|--------------------------------------------------------------------------
| Path where all images for items was stored
|--------------------------------------------------------------------------
*/
$config['store']['items_images'] = 'store'.DIRECTORY_SEPARATOR.'items';

/*
|--------------------------------------------------------------------------
| Path where all images for solutions was stored
|--------------------------------------------------------------------------
*/
$config['store']['solutions_images'] = 'store'.DIRECTORY_SEPARATOR.'solutions';

/*
|--------------------------------------------------------------------------
| Path where all images for question was stored
|--------------------------------------------------------------------------
*/
$config['store']['questions_images'] = 'store'.DIRECTORY_SEPARATOR.'question';

/*
|--------------------------------------------------------------------------
| Path where all images for answers was stored
|--------------------------------------------------------------------------
*/
$config['store']['answers_images'] = 'store'.DIRECTORY_SEPARATOR.'answer';

/*
|--------------------------------------------------------------------------
| Size for thumbnails width
|--------------------------------------------------------------------------
*/
$config['store']['thumbnails_images_width'] = 90;

/*
|--------------------------------------------------------------------------
| Size for thumbnails frontend of news or partners
|--------------------------------------------------------------------------
*/
$config['store']['frontend_thumbnails_images_height'] = 150;
$config['store']['frontend_thumbnails_images_width'] = 190;

/*
|--------------------------------------------------------------------------
| Size for thumbnails height
|--------------------------------------------------------------------------
*/
$config['store']['thumbnails_images_height'] = 50;
...
/*
|--------------------------------------------------------------------------
| Prefix for frontend thumbnails
|--------------------------------------------------------------------------
*/
$config['store']['fr_thumbnails_prefix'] = 'fr_thumb_';
