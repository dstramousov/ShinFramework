{include file="web/fr_header2.tpl"}
                        ...
                        <td width="470" valign="top">
                                ...
                                <tr>
                                    <td height="36">
                                        <table width="470" height="36" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="36"><img src="{php}echo SHIN_Core::$_config['core']['app_base_url'];{/php}/images/web/icon.jpg" width="36" height="36" alt="" /></td>
                          ...
                          <td width="288" valign="top">
                            <table width="288" height="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="47" valign="bottom" background="{php}echo SHIN_Core::$_config['core']['app_base_url'];{/php}/images/web/leftop.jpg" style="background-repeat: no-repeat;">
                                        <div align="right">
...
{literal}
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.ajax({
                url:        '{/literal}{php}echo prep_url(base_url() . '/getpartners');{/php}{literal}',
                dataType:   'jsonp',
                data:       {count: 3},
            ...
            $.ajax({
                url:        '{/literal}{php}echo prep_url(base_url() . '/getnews');{/php}{literal}',
                dataType:   'jsonp',
        ...
        function itemClick(type, itemId){
            $.ajax({
                url:        '{/literal}{php}echo prep_url(base_url() . '/webapi-json/click');{/php}{literal}',
