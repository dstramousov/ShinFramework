...
class CategoryManagmentController {
   
    /**
    * tab name
    */
    protected $tabName  =   'category';
    
    /**
    * model name
    */
    protected $modelName = 'gtrwebsite_itemscategory_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array(SHIN_Core::$_language->line('lng_label_item_category_iditem'),
                                SHIN_Core::$_language->line('lng_label_item_category_description'),
                                SHIN_Core::$_language->line('lng_label_item_category_user_insert'),
                                SHIN_Core::$_language->line('lng_label_item_category_date_insert'),
                                SHIN_Core::$_language->line('lng_label_item_category_user_mod'),
                                SHIN_Core::$_language->line('lng_label_item_category_date_modifiy'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idItemCat,description,sys_user_ins_name,dataIns,sys_user_mod_name,dataMod" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "categoryCrudObj" } ),
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_delete_cancel') => 'categoryCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_delete_ok') => 'categoryCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit_title'), null, Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit_cancel') => 'categoryCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit') => 'categoryCrudObj.write("edit-dialog")'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add_cancel') => 'categoryCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add') => 'categoryCrudObj.write("add-dialog")'));
        ...
        // init add button
        $options    = array('click' => 'categoryCrudObj.openDialog(null, "add"); return false;',
        ...
        return 'managment/item/category/category-list.tpl'; 
    ...
    */
    public function read(){
        ...
        return 'managment/item/category/category-info.tpl';
    }
    ...
    */
    ...
    public function countItems(){
        ...
        $idItemCat  =  isset($_REQUEST['idItemCat']) ? $_REQUEST['idItemCat'] : null;
        
        echo json_encode(array('count' => SHIN_Core::$_models[$this->modelName]->getCountItems($idItemCat))); exit();
    }
