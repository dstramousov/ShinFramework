...
class PartnerController {
    ...
    * tab name
    */
    protected $tabName  =   'partners';
    
    /**
    * model name
    */
    protected $modelName = 'gtrwebsite_partners_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array(SHIN_Core::$_language->line('lng_label_partners_id'),
                                SHIN_Core::$_language->line('lng_label_partners_type'),
                                SHIN_Core::$_language->line('lng_label_partners_field'),
                                SHIN_Core::$_language->line('lng_label_partners_name'),
                                SHIN_Core::$_language->line('lng_label_partners_desc'),
                                SHIN_Core::$_language->line('lng_label_partners_img'),
                                SHIN_Core::$_language->line('lng_label_partners_link'),
                                SHIN_Core::$_language->line('lng_label_partners_inserted_by'),
                                SHIN_Core::$_language->line('lng_label_partners_inserted_date'),
                                SHIN_Core::$_language->line('lng_label_partners_updated_by'),
                                SHIN_Core::$_language->line('lng_label_partners_updated_date'),
                                SHIN_Core::$_language->line('lng_label_partners_clicks'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idPartner,partnerType,partnerField,name,descShort,img,link,sys_user_ins_name,dataIns,sys_user_mod_name,dataMod,clicks" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "partnerCrudObj" } ),
        ...
        $init_options    = array('bProcessing'  => 'true', 
                                 ...
                                 'aoColumns'    => '[null,null,null,null,null,null,null,null,null,null,null,null,{"bSortable":false},{"bSortable":false}]',
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_delete_cancel') => 'partnerCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_delete_ok') => 'partnerCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit_title'), null, Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit_cancel') => 'partnerCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_edit') => 'partnerCrudObj.write("edit-dialog", collectAdditionalData, uploadCallback)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-edit-dialog'));
        
        // init add dialog
        SHIN_Core::$_libs['dialog']->init(array('width' => 500));
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add_cancel') => 'partnerCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_' . $this->tabName . '_add') => 'partnerCrudObj.write("add-dialog", collectAdditionalData, uploadCallback)'));
        ...
        // init add button
        $options    = array('click' => 'partnerCrudObj.openDialog(null, "add"); return false;',
        ...
        return 'partner/partner-list.tpl'; 
    ...
    */
    public function read(){
        ...
        $uploaderOptions = array('fileDataName'     => '"gtrwebsite_partners_img"',
                                 'multi'            => 'false',
                                 'auto'             => 'false',
                                 'queueSizeLimit'   => 1,
                                 'script'           => "'" . prep_url(base_url().'/partner/upload') . "'",
                                 'fileExt'          => "'*.jpg;*.gif;*.png;'",
                                 'onSelect'         => 'partnerOnSelectCallback',
                                 'onCancel'         => 'partnerOnCancelCallback',
                                 'onAllComplete'    => 'onAllComplete');
    
        // init uploader first button                         
        SHIN_Core::$_libs['upload']->init($uploaderOptions);
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['upload']->render('partnerImgUploader'));
        
        return 'partner/partner-info.tpl';
    }
