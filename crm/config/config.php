...
| URL to your site root. Typically this will be your base URL,
|
|	http://mywork/shinframework/crm
|
*/
$config['core']['app_base_url']	= $config['core']['shinfw_base_url']."/crm";
...
|--------------------------------------------------------------------------
|
| Where is placed your application,
|
*/
...
|
*/
$config['core']['benchmark_debug_information'] = TRUE;
...
|--------------------------------------------------------------------------
|
| Read more: http://ua2.php.net/manual/en/function.date-default-timezone-set.php
| And: http://ua2.php.net/manual/en/timezones.php
|
*/
$config['core']['date_default_timezone_set'] = 'Europe/Kiev';
...
|--------------------------------------------------------------------------
*/
$config['theme']['general_css_file'] = $config['core']['shinfw_base_url'].'/'.$config['core']['shinfw_folder']."/themes/general.css";
