...
|
|	http://mywork/shinframework/examples
|
*/
$config['core']['app_base_url']	= $config['core']['shinfw_base_url'].'/examples';
...
*/
$config['input']['csrf_protection'] = TRUE;
...
|--------------------------------------------------------------------------
*/
$config['theme']['default_theme'] = "redmond"; // "default", "redmond", "smoothness", "darkness" is also available
...
|--------------------------------------------------------------------------
*/
$config['input']['default_form_input_extra'] = 'width:300px;';
...
|--------------------------------------------------------------------------
*/
$config['input']['pager_class_name'] = 'SHIN_MobilePagination';
