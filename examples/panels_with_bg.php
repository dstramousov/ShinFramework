 ...
 */
    ...
    * - for links and images panels we initialize bg image and male position for it
    */
    $options    = array('ajax_url'   =>  shinfw_base_url() . '/' . shinfw_folder() . '/connectors/savestate.php',
                        'model_name' =>  'examples_panel',
                        'bg_images' =>  array('links'  => array('img'  =>  base_url() . '/uploads/pozitiffff_37.jpg',
                                                                'pos'  =>  'top left'),
                                              'images' => array('img'  =>  base_url() . '/uploads/pozitiffff_38.jpg',
                                                                'pos'  =>  'top left')));
...
/* End of file panels_with_bg.php */
/* Location: example/panels_with_bg.php */