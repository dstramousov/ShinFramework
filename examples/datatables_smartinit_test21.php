...
//	                            'SHIN_Benchmark',
	...
	$where = '';
	if(param('idItemCat')){
		$where = 'examples_file_tracking_data.file_id=' . param('idItemCat');
	}
	
	//dump($where);
	
	$init_data = array(
						'tab_name'      => 'examples_file_tracking2',
						'model_name'    => 'examples_file_tracking_data',
						...
						'display_data'	=> array('id', 'file_id','description'),
                        'table_labels'  => array('ID','File ID', 'Description')
	);
	...
	SHIN_Core::finalrender('datatables_smartinit21');
