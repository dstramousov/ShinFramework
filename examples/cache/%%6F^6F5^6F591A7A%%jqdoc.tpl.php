<?php /* Smarty version 2.6.26, created on 2011-05-10 14:23:14
         compiled from jqdoc.tpl */ ?>
                ...
                <td style="width: 250px;">
                    <fieldset>
                        <legend style="font-size: 20px; font-weight: bold;">Fade in</legend>
                          <div id='menu3'>
                            <img src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/previous.png' title='Previous' alt='jqdoc/previous.png' />
                            <img src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/stop.png' title='Stop' alt='jqdoc/stop.png' />
                            <img src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/pause.png' title='Pause' alt='jqdoc/pause.png' />
                            <img src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/play.png' title='Play' alt='jqdoc/play.png' />
                            <img src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/next.png' title='Next' alt='jqdoc/next.png' />
                          </div>
                    </fieldset>
                </td>
            </tr>
                ...
                <td style="width: 250px;">
                    <fieldset>
                        <legend style="font-size: 20px; font-weight: bold;">Change image source</legend>
                          <div id='menu4'>
                            <img id='prevBtn' src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/previous.png' title='Previous' alt='jqdoc/previous.png' />
                            <img id='stopBtn' src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/stop.png' title='Stop' alt='jqdoc/stop.png' />
                            <img id='playBtn' src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/play.png' title='Play' alt='jqdoc/play.png' />
                            <img id='nextBtn' src='<?php  echo prep_url(shinfw_base_url().'/examples/');  ?>jqdoc/next.png' title='Next' alt='jqdoc/next.png' />
                          </div>
                          <div id='playerState'>
