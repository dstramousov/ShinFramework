<?php /* Smarty version 2.6.26, created on 2011-05-17 10:37:42
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php echo $this->_tpl_vars['dialog_container1']; ?>

    <input type="button" value="Open dialog" id="opener1">
    <br><br>

    <?php echo $this->_tpl_vars['dialog_container2']; ?>

    <input type="button" value="Open modal dialog" id="opener2">

    <br><br>
    <?php echo $this->_tpl_vars['dialog_container']; ?>

    <input type="button" value="Open confirm dialog" id="opener3">

    <br><br>
    <?php echo $this->_tpl_vars['dialog_container4']; ?>
