...
$datepicker_ext['js'] = array(SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/jquery/jquery.js', 
                              ...
                              SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/jqueryUI/jquery.ui.datepicker-en.js');

$datepicker_ext['min_js'] = array(SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/jquery/jquery.js', 
...
| -------------------------------------------------------------------
*/
$datepicker_ext['css'] = array(SHIN_Core::$_config['theme']['theme_root_dir'] . '/' . SHIN_Core::get_theme_path().'/css/jqueryUI/jquery.ui.all.css');
...
| -------------------------------------------------------------------
*/
$datepicker['buttonImage'] = '"' . SHIN_Core::$_config['theme']['theme_root_dir'] . '/' . SHIN_Core::get_theme_path() . '/css/datepicker/images/calendar.gif"';
