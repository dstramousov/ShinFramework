...
$datatable_ext['min_js'] = array(SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/jquery/jquery.js', 
                             SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/datatables/jquery.dataTables.js');
...
| -------------------------------------------------------------------
*/
$datatable_ext['css'] = array(SHIN_Core::$_config['theme']['theme_root_dir'] . '/' . SHIN_Core::get_theme_path().'/css/jqueryUI/jquery.ui.all.css', 
                              SHIN_Core::$_config['theme']['theme_root_dir'] . '/' . SHIN_Core::get_theme_path().'/css/datatables/demo_table_jui.css');
...
| -------------------------------------------------------------------
*/
$datatable['sAjaxSource'] = "'".SHIN_Core::$_config['core']['app_base_url'].'/SHIN_Connector.php'."'";
