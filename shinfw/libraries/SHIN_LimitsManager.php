...
/**
 * snaptrack/libraries/SHIN_LimitsManager.php
 *
 * This file implemet all limitations in  snaptrack web site.
 *
 * @version 1.0
...
class SHIN_LimitsManager {
    ...
    */
    function checkRemaingQuota($fileSize, $userId) {
        ...
        $totalUsedSpace  =   SHIN_Core::$_models['snaptrack_uploadactivity_model']->getUsersBandWidth($userId, date('Y-m-d'));
...
/* Location: snaptrack/libraries/SHIN_LimitsManager.php */