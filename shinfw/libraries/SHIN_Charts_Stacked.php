 ...
 * @link        
 * @since        Version 0.1
 * @filesource   shinfw/libraries/SHIN_Charts_Stacked.php
 */
 ...
 * @subpackage    Library
 * @author        
 * @link          shinfw/libraries/SHIN_Charts_Stacked.php
 */
...
class SHIN_Charts_Stacked extends SHIN_Charts
{
    ...
    * @var array
    */
    private $chartList      =   array('c2d' => "'StackedColumn2D'", 
                                      'c3d' => "'StackedColumn3D'", 
                                      'a2d' => "'StackedArea2D'", 
                                      'b2d' => "'StackedBar2D'");
...
/* End of file SHIN_Charts_Stacked.php */
/* Location: ./libraries/SHIN_Charts_Stacked.php */               