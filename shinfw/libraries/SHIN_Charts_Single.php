 ...
 * @link        
 * @since        Version 0.1
 * @filesource   shinfw/libraries/SHIN_Charts_Single.php
 */
 ...
 * @subpackage    Library
 * @author        
 * @link          shinfw/libraries/SHIN_Charts_Single.php
 */
...
class SHIN_Charts_Single extends SHIN_Charts
{
    ...
    * @var array
    */
    private $chartList      =   array('c2d' => "'Column2D'", 
                                      'c3d' => "'Column3D'", 
                                      'p2d' => "'Pie2D'",      
                                      'p3d' => "'Pie3D'", 
                                      'l2d' => "'Line2D'",
    ...
    public function combinedInit($_arr)
    {
        ...
        if(count($_arr['data'])) {
            foreach($_arr['data'] as $iterator)
            {
                ...
                $__data .= '<set' . $this->getTagAttributes('set') . ' name="' .  $__n . '"' . (!empty($__v) && !is_null($__v) ? ' value = "' . $__v . '"' : '') . ' color="' . $iterator['color'] . '" />';
            }
        }
        
        $data   = "'<graph " . $this->getTagAttributes('graph') . ">" . $__data . "</graph>'";
...
/* End of file SHIN_Charts_Single.php */
/* Location: ./libraries/SHIN_Charts_Single.php */               