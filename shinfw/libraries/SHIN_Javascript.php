...
class SHIN_Javascript extends SHIN_Libs {

	var $_javascript_location = 'js';

	function __construct($css_file = false)
	{		
        parent::__construct('javascript', $css_file);

		$__lib = SHIN_Core::$_config['core']['subclass_prefix'].ucfirst($this->sh_Options['js_library_driver']);
		require_once(BASEPATH.'libraries/'.$__lib.'.php');
        $this->js = new $__lib($this->sh_Options);
		
		SHIN_Core::log('debug', "Javascript Class Initialized and loaded.  Driver used: $__lib");
	 ...
	 * @param	string	- Javascript callback function
 	 * @return	string
	 */
	function fadeIn($element = 'this', $speed = 'normal', $callback = '')
	{
	 ...
	 * @param	string	- Javascript callback function
 	 * @return	string
	 */
	function fadeOut($element = 'this', $speed = 'normal', $callback = '')
	{
	 ...
	 * @param	string	- Javascript callback function
 	 * @return	string
	 */
	function slideUp($element = 'this', $speed = 'normal', $callback = '')
	{
	 ...
	 * @param	string	- Javascript callback function
 	 * @return	string
	 */
	function slideDown($element = 'this', $speed = 'normal', $callback = '')
	{
	 ...
	 * @param	string	- Javascript callback function
 	 * @return	string
	 */
	function slideToggle($element = 'this', $speed = 'normal', $callback = '')
	{
	...
	{
		SHIN_Core::$_jsmanager->addIncludes($this->js->_javascript_location);	
		SHIN_Core::$_jsmanager->addComponent($this->js->_compile($view_var, $script_tags));
		return;
	...
	function external($external_file = '', $relative = FALSE)
	{
		if ($external_file !== '')
		{
			...
			if ($this->sh_Options['javascript_location'] != '')
			{
				$this->_javascript_location = $this->sh_Options['javascript_location'];
			}
		}
		...
		{			
			$str = $this->_open_script(SHIN_Core::$_config['core']['app_base_url'].$this->_javascript_location.$external_file);
		}
	...
	{
		$str = '<script type="text/javascript" charset="'.strtolower(SHIN_Core::$_config['core']['charset']).'"';
		$str .= ($src == '') ? '>' : ' src="'.$src.'">';
		return $str;
	}
...
/* End of file SHIN_Javascript.php */
/* Location: shinfw/libraries/SHIN_Javascript.php */