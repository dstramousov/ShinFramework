 ...
 * @link        
 * @since        Version 0.1
 * @filesource   shinfw/libraries/SHIN_Lightbox.php
 */
 ...
 * @subpackage    Library
 * @author        
 * @link          shinfw/libraries/SHIN_Lightbox.php
 */


class SHIN_Lightbox extends SHIN_Libs
{
    ...
    {   
        parent::__construct('lightbox', $css_file);
    
		Console::logSpeed('SHIN_Lightbox begin work, Time taken to get to line: '.__FILE__.'::'.__LINE__);
		Console::logMemory($this, 'SHIN_Lightbox. Size of class: ');		        
    }
    ...
    {   
        $injectedCode  = '$("' . $this->htmlID .'").prettyPhoto({';
