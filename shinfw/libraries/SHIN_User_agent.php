...
class SHIN_User_agent {
	...
	public function __construct()
	{
		...
		Console::logSpeed('SHIN_User_Agent begin work, Time taken to get to line: '.__FILE__.'::'.__LINE__);
		Console::logMemory($this, 'SHIN_User_Agent. Size of class: ');
	}
	...
	{
		@include(SHIN_Core::isConfigExists('user_agents.php'));
