...
class SHIN_Jquery  extends SHIN_Javascript {
	...
	{			
		$this->sh_Options = $params;
		$_javascript_folder = $this->sh_Options[$this->sh_Options['js_library_driver']]['javascript_folder'];
		$this->script();			
	}
	...
	{	
		...
		$controller = (strpos('://', $controller) === FALSE) ? $controller : SHIN_Core::$_config['core']['app_base_url'];
		
		// ajaxStart and ajaxStop are better choices here... but this is a stop gap
		if (SHIN_Core::$_config['core']['javascript_ajax_img'] == '')
		{
			$loading_notifier = "Loading...";
		}
		else
		{
			$loading_notifier = '<img src=\'' . SHIN_Core::$_config['core']['shinfw_base_url'] . SHIN_Core::$_config['core']['javascript_ajax_img'] . '\' alt=\'Loading\' />';
		}
	 ...
	 * @return	string
	 */
	function _compile($view_var = 'script_foot', $script_tags = TRUE, $_add_doc_ready=FALSE)
	{
		// External references
		$external_scripts = implode('', $this->jquery_code_for_load);
		//SHIN_Core::loadLibrary($external_scripts);
		...
		$script = '';
		// Inline references
		if($_add_doc_ready){$script = '$(document).ready(function() {' . "\n";}
		$script .= implode('', $this->jquery_code_for_compile);
		if($_add_doc_ready){$script .= '});';}
...
/* End of file SHIN_Jquery.php */
/* Location: shinfw/libraries/SHIN_Jquery.php */