 ...
 * @link		
 * @since		Version 0.1
 * @filesource	shinfw/core/database/SHIN_DB_active_record.php
 */
...
require_once(COREPATH.'db/SHIN_DB_driver.php');
require_once(COREPATH.'db/SHIN_DB_result.php');

class SHIN_DB_active_record extends SHIN_DB_driver {
...
/* End of file SHIN_DB_active_record.php */
/* Location: shinfw/core/database/SHIN_DB_active_record.php */