<?php /* Smarty version 2.6.26, created on 2011-03-10 09:58:18
         compiled from sys_manage/list/policy-sub-area-list.tpl */ ?>
<div id="list">
            ...
            <script type="text/javascript">
                ...
                */
                function collectAdditionalData(){
                    additionalData  =   {
                        sys_policysubarea_idSubArea_old: $(\'#sys_policysubarea_idSubArea_old\').val(),   
                        sys_policysubarea_idArea_old:    $(\'#sys_policysubarea_idArea_old\').val(),   
                        sys_policysubarea_idElem_old:    $(\'#sys_policysubarea_idElem_old\').val()   
                    };
