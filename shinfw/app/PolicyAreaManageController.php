...
class PolicyAreaManageController extends CommonController {
   
    /**
    * tab name
    */
    protected $tabName  =   'policy_area';
    
    /**
    * model name
    */
    protected $modelName = 'sys_policyarea_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array('',
                                SHIN_Core::$_language->line('lng_label_sys_policy_id'),
                                SHIN_Core::$_language->line('lng_label_sys_policy_type'),
                                '',
                                SHIN_Core::$_language->line('lng_label_sys_policy_area'),
                                SHIN_Core::$_language->line('lng_label_sys_policy_mode'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idElem,sys_userrole_role,type,idArea,sys_structarea_area,mode" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "policyAreaCrudObj" } ),
        ...
        $init_options    = array('bProcessing'  => 'true', 
                                 ...
                                 'aoColumns'    => '[{"bVisible":false},null,null,{"bVisible":false},null,null,{"bSortable":false},{"bSortable":false}]',
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_customer_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_sys_user_cancel') => 'policyAreaCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_delete_ok') => 'policyAreaCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_sys_policy_edit'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_edit_cancel') => 'policyAreaCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_edit_ok') => 'policyAreaCrudObj.write("edit-dialog", collectAdditionalData)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_sys_policy_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_add_cancel') => 'policyAreaCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_add_ok') => 'policyAreaCrudObj.write("add-dialog", collectAdditionalData)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-add-dialog'));

        // init messages and errors blocks
        SHIN_Core::$_libs['templater']->assign('jsMessages',  SHIN_Core::$_libs['message']->getMessageBlock('policy-js-message'));
        SHIN_Core::$_libs['templater']->assign('jsErrors',    SHIN_Core::$_libs['message']->getErrorBlock('policy-js-error'));
        
        // init add button
        $options    = array('click' => 'policyAreaCrudObj.openDialog(null, "add"); return false;',
    ...
    */
    public function read(){
        ...
        return 'sys_manage/dialog/policy-area-info.tpl';
    }
    ...
    */
    public function create(){
        ...
        SHIN_Core::$_models['sys_policyarea_model']->oldElemId   =   SHIN_Core::$_input->post('sys_policyarea_idElem_old');
        SHIN_Core::$_models['sys_policyarea_model']->oldIdArea   =   SHIN_Core::$_input->post('sys_policyarea_idArea_old');
