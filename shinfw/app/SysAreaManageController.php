...
class SysAreaManageController extends CommonController {
   
    /**
    * tab name
    */
    protected $tabName  =   'sys_area';
    
    /**
    * model name
    */
    protected $modelName = 'sys_structarea_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array(SHIN_Core::$_language->line('lng_label_sys_area_id'),
                                SHIN_Core::$_language->line('lng_label_sys_area_area'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idArea,area" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "sysAreaCrudObj" } ),
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_customer_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_sys_user_cancel') => 'sysAreaCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_delete_ok') => 'sysAreaCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_sys_area_edit'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_edit_cancel') => 'sysAreaCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_edit_ok') => 'sysAreaCrudObj.write("edit-dialog", collectAdditionalData)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_sys_area_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_add_cancel') => 'sysAreaCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_add_ok') => 'sysAreaCrudObj.write("add-dialog", collectAdditionalData)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-add-dialog'));

        // init messages and errors blocks
        SHIN_Core::$_libs['templater']->assign('jsMessages',  SHIN_Core::$_libs['message']->getMessageBlock('sys-area-js-message'));
        SHIN_Core::$_libs['templater']->assign('jsErrors',    SHIN_Core::$_libs['message']->getErrorBlock('sys-area-js-error'));
        
        // init add button
        $options    = array('click' => 'sysAreaCrudObj.openDialog(null, "add"); return false;',
        ...
        $crudInitData   =   array('tab_name'            =>   $this->tabName,
                                  ...
                                  'crud_obj_name'       =>   'sysAreaCrudObj',
                                  'datatable_name'      =>   $_element_id,
                                  'message_block'       =>   'sys-area-js-message',
                                  'error_block'         =>   'sys-area-js-error',
                                  'error_prefix'        =>   '_error',
        ...
        return 'sys_manage/list/sys-area-list.tpl'; 
    ...
    */
    public function read(){
        ...
        return 'sys_manage/dialog/area-info.tpl';
    }
