...
class PolicyApplicationManageController extends CommonController {
   
    /**
    * tab name
    */
    protected $tabName  =   'policy_application';
    
    /**
    * model name
    */
    protected $modelName = 'sys_policyapplication_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array('',
                                SHIN_Core::$_language->line('lng_label_policy_application_id_elem'),
                                SHIN_Core::$_language->line('lng_label_policy_application_type'),
                                '',
                                SHIN_Core::$_language->line('lng_label_policy_application_id_area'),
                                SHIN_Core::$_language->line('lng_label_policy_application_id_sub_area'),
                                SHIN_Core::$_language->line('lng_label_policy_application_id_application'),
                                SHIN_Core::$_language->line('lng_label_policy_application_mode'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idElem,sys_userrole_role,type,idArea,sys_structarea_area,idSubArea,sys_structapplication_application,mode" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "policyAppCrudObj" } ),
        ...
        $init_options    = array('bProcessing'  => 'true', 
                                 ...
                                 'aoColumns'    => '[{"bVisible":false},null,null,{"bVisible":false},null,null,null,null,{"bSortable":false},{"bSortable":false}]',
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_customer_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_sys_user_cancel') => 'policyAppCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_delete_ok') => 'policyAppCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_policy_application_edit'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_edit_cancel') => 'policyAppCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_edit_ok') => 'policyAppCrudObj.write("edit-dialog", collectAdditionalData)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_policy_application_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_add_cancel') => 'policyAppCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_add_ok') => 'policyAppCrudObj.write("add-dialog", collectAdditionalData)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-add-dialog'));

        // init messages and errors blocks
        SHIN_Core::$_libs['templater']->assign('jsMessages',  SHIN_Core::$_libs['message']->getMessageBlock('policy-app-js-message'));
        SHIN_Core::$_libs['templater']->assign('jsErrors',    SHIN_Core::$_libs['message']->getErrorBlock('policy-app-js-error'));
        
        // init add button
        $options    = array('click' => 'policyAppCrudObj.openDialog(null, "add"); return false;',
                            'label' => '"' . SHIN_Core::$_language->line('lng_label_policy_application_add') . '"');
        ...
        $crudInitData   =   array('tab_name'            =>   $this->tabName,
                                  ...
                                  'crud_obj_name'       =>   'policyAppCrudObj',
                                  'datatable_name'      =>   $_element_id,
                                  'message_block'       =>   'policy-app-js-message',
                                  'error_block'         =>   'policy-app-js-error',
                                  'error_prefix'        =>   '_error',
                                  'validation_class'    =>   '.validatetion-error',
                                  'controller'          =>   'policyapplicationmanage');

		SHIN_Core::$_libs['templater']->assign('crudData', SHIN_Core::$_models[$this->modelName]->prepareCodeforCRUD($crudInitData));

        return 'sys_manage/list/policy-application-list.tpl'; 
    ...
    */
    public function read(){
        ...
        return 'sys_manage/dialog/policy-application-info.tpl';
    }
    ...
    */
    public function create(){
        ...
        SHIN_Core::$_models[$this->modelName]->oldElemId    =   SHIN_Core::$_input->post('sys_policyapplication_idElem_old');
                                      
        SHIN_Core::$_models[$this->modelName]->read_form();
        SHIN_Core::$_models[$this->modelName]->storePolicyApplication();
    ...
    */
    public function getApplicationList(){
        ...
        // load languge files for each application
        $this->_loadApplicationLang();
        
        $areaId     =   isset($_REQUEST['areaId'])      ? $_REQUEST['areaId']    : '';
        $subAreaId  =   isset($_REQUEST['subAreaId'])   ? $_REQUEST['subAreaId'] : '';
        
        echo json_encode(SHIN_Core::$_models['sys_structapplication_model']->getApplicationListForDD($areaId, $subAreaId)); exit();    
    }
}
