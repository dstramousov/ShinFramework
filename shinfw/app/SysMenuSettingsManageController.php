...
class SysMenuSettingsManageController extends CommonController {
   
    /**
    * tab name
    */
    protected $tabName  =   'sys_menu_settings';
    
    /**
    * model name
    */
    protected $modelName = 'sys_menusettings_model';
    ...
    */
    public function index(){
        ...
        $_table_data    = array(SHIN_Core::$_language->line('lng_label_sys_menu_id_menu'),
                                '',
                                SHIN_Core::$_language->line('lng_label_sys_menu_user_name'),
                                SHIN_Core::$_language->line('lng_label_sys_menu_id_pabel'),
                                SHIN_Core::$_language->line('lng_label_sys_menu_panel_collapsed'),
                                SHIN_Core::$_language->line('lng_label_sys_menu_panel_maximized'),
                                SHIN_Core::$_language->line('lng_label_sys_menu_panel_order_menu'),
                                SHIN_Core::$_language->line('lng_label_sys_menu_panel_column_menu'),
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idMenu,idUser,sys_user_name,idPanel,collapsed,maximized,order_menu,column_menu,color_class,color_border_class,color_bg_class,show_close,show_maximize,show_turn,show_info" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "sysMenuSettingsCrudObj" } ),
        ...
        $init_options    = array('bProcessing'  => 'true', 
                                 ...
                                 'aoColumns'    => '[null,{"bVisible":false}, null, null, null, null, null, null, null, null, null, null, null, null, null, {"bSortable":false}, {"bSortable":false}]',
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_customer_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_sys_user_cancel') => 'sysMenuSettingsCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_delete_ok') => 'sysMenuSettingsCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_sys_menu_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_add_cancel') => 'sysMenuSettingsCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_add_ok') => 'sysMenuSettingsCrudObj.write("add-dialog", collectAdditionalData)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-add-dialog'));

        // init messages and errors blocks
        SHIN_Core::$_libs['templater']->assign('jsMessages',  SHIN_Core::$_libs['message']->getMessageBlock('sys-menu-settings-message'));
        SHIN_Core::$_libs['templater']->assign('jsErrors',    SHIN_Core::$_libs['message']->getErrorBlock('sys-menu-settings-error'));
        
        // init add button
        $options    = array('click' => 'sysMenuSettingsCrudObj.openDialog(null, "add"); return false;',
        ...
        $crudInitData   =   array('tab_name'            =>   $this->tabName,
                                  ...
                                  'crud_obj_name'       =>   'sysMenuSettingsCrudObj',
                                  'datatable_name'      =>   $_element_id,
                                  'message_block'       =>   'sys-menu-settings-message',
                                  'error_block'         =>   'sys-menu-settings-error',
                                  'error_prefix'        =>   '_error',
                                  'validation_class'    =>   '.validatetion-error',
                                  'controller'          =>   'menusettingsmanage');
        SHIN_Core::$_libs['templater']->assign('crudData', SHIN_Core::$_models[$this->modelName]->prepareCodeforCRUD($crudInitData));
        
        
        return 'sys_manage/list/sys-menu-settings-list.tpl'; 
    ...
    */
    public function read(){
        ...
        SHIN_Core::$_libs['templater']->assign('lastRec', SHIN_Core::$_models['sys_menusettings_model']->getMaxRecord());
        
        return 'sys_manage/dialog/sys-menu-settings-info.tpl';
    }
    ...
    */
    public function create(){
        ...
        SHIN_Core::$_models[$this->modelName]->oldMenuId  =   SHIN_Core::$_input->post('sys_menusettings_idMenu_old');;
        SHIN_Core::$_models[$this->modelName]->oldUserId  =   SHIN_Core::$_input->post('sys_menusettings_idUser_old');
        SHIN_Core::$_models[$this->modelName]->oldPanelId =   SHIN_Core::$_input->post('sys_menusettings_idPanel_old');
