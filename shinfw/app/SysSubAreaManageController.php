...
class SysSubAreaManageController extends CommonController {
   
    /**
    * tab name
    */
    protected $tabName  =   'sys__sub_area';
    
    /**
    * model name
    */
    protected $modelName = 'sys_structsubarea_model';
    ...
    */
    public function index(){
        ...
        $_display_data  = array();
        $_table_data    = array(SHIN_Core::$_language->line('lng_label_sys_sub_area_id'),
                                '',
                                SHIN_Core::$_language->line('lng_label_sys_area_id'),
                                SHIN_Core::$_language->line('lng_label_sys_sub_area'),
                                '', '');
        ...
        $fnServerData = 'function ( sSource, aoData, fnCallback ) {
                                            ...
                                            aoData.push( { "name": "needed_column",   "value": "idSubArea,idArea,sys_structarea_area,subarea" } ),
                                            aoData.push( { "name": "custom_column",   "value": "edit,delete" } ),
                                            aoData.push( { "name": "crud_obj_name",   "value": "sysSubAreaCrudObj" } ),
        ...
        $init_options    = array('bProcessing'  => 'true', 
                                 ...
                                 'aoColumns'    => '[null,{"bVisible":false},null,null,{"bSortable":false},{"bSortable":false}]',
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-delete-dialog', SHIN_Core::$_language->line('lng_label_customer_delete_really'), 'Content', Array(SHIN_Core::$_language->line('lng_label_sys_user_cancel') => 'sysSubAreaCrudObj.params.general.dialogObj.close("delete-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_delete_ok') => 'sysSubAreaCrudObj.del(null, null)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-edit-dialog', SHIN_Core::$_language->line('lng_label_sys_sub_area_edit_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_edit_cancel') => 'sysSubAreaCrudObj.params.general.dialogObj.close("edit-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_edit_ok') => 'sysSubAreaCrudObj.write("edit-dialog", collectAdditionalData)'));
        ...
        SHIN_Core::$_libs['dialog']->confirm_dialog_correct($this->tabName . '-add-dialog', SHIN_Core::$_language->line('lng_label_sys_sub_area_add_title'), null, Array(SHIN_Core::$_language->line('lng_label_sys_user_add_cancel') => 'sysSubAreaCrudObj.params.general.dialogObj.close("add-dialog")', SHIN_Core::$_language->line('lng_label_sys_user_add_ok') => 'sysSubAreaCrudObj.write("add-dialog", collectAdditionalData)'));
        SHIN_Core::$_jsmanager->addComponent(SHIN_Core::$_libs['dialog']->render($this->tabName . '-add-dialog'));

        // init messages and errors blocks
        SHIN_Core::$_libs['templater']->assign('jsMessages',  SHIN_Core::$_libs['message']->getMessageBlock('sub-area-js-message'));
        SHIN_Core::$_libs['templater']->assign('jsErrors',    SHIN_Core::$_libs['message']->getErrorBlock('sub-area-js-error'));
        
        // init add button
        $options    = array('click' => 'sysSubAreaCrudObj.openDialog(null, "add"); return false;',
                            'label' => '"' . SHIN_Core::$_language->line('lng_label_sys_sub_area_add') . '"');
    ...
    */
    public function read(){
        ...
        return 'sys_manage/dialog/sub-area-info.tpl';
    }
    ...
    */
    public function create(){
        ...
        SHIN_Core::$_models[$this->modelName]->oldSubAreaId = SHIN_Core::$_input->post('sys_structsubarea_idSubArea_old');
        SHIN_Core::$_models[$this->modelName]->oldAreaId    = SHIN_Core::$_input->post('sys_structsubarea_idArea_old');
