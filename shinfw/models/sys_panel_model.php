...
class Sys_Panel_model extends SHIN_Model {

    /**
     * Physical tablename.
     */
    var $table_name = 'sys_panel';
    ...
    function __construct() 
	{
        ...
        $this->insert_field(array(
			...
			'value'  => $this->generateUniqPanelName(),   // sample !!!!!
        ));
	...
	function generateUniqPanelName(){
		return '';
	}
    ...
    function getPanelParams(){
        ...
        SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->select_max('column', 'total');
		...
		SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->order_by('order', 'asc'); 
        $result = SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->get($this->table_name);
