...
$lang['db_unsupported_function'] = 'Funzionalità non è disponibile per il database che si sta utilizzando.';
...
$lang['db_unsuported_feature'] = 'Funzionalita non supportata dalla piattaforma di database in uso.';
$lang['db_unsuported_compression'] = 'Il formato di compressione dei file che è stato scelto non è supportato dal server in uso.';
$lang['db_filepath_error'] = 'Impossibile scrivere i dati nella path che è stata immessa.';
$lang['db_invalid_cache_path'] = 'La path della chace che è stata immessa non è valida o non è scrivibile.';
