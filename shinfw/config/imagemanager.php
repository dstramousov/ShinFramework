<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../examples/uploads/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../examples/uploads/'; // absolute or relative from this script path, required.
        $mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
        $mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
        $mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/\.svn$/i';
        ...
        $mcImageManagerConfig['stream.exclude_file_pattern'] = '/\.php$|\.shtm$|\.svn$/i';
