<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../examples/uploads/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../examples/uploads/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
        $mcFileManagerConfig['filesystem.include_directory_pattern'] = '';
        $mcFileManagerConfig['filesystem.exclude_directory_pattern'] = '/\.svn$/i';
        ...
        $mcFileManagerConfig['stream.exclude_file_pattern'] = '/\.php$|\.shtm$|\.svn$/i';
