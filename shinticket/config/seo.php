...
| -------------------------------------------------------------------
*/
$seo['description'] = 'SHINTicket is designed to help you streamline support requests and improve customer support efficiency by providing staff with tools they need to deliver fast, effective and measurable support.';
...
| -------------------------------------------------------------------
*/
$seo['expires'] = gmdate("D, d M Y H:i:s", time()+86400*365)." GMT";
...
| -------------------------------------------------------------------
*/
$seo['keywords'] = 'shinticket, helpdesk, support ticket system, customer support system, trouble ticket, support ticket, ticketing, piping, php, open source,help desk software, helpdesk software, open soure e-mail ticket sytem';
