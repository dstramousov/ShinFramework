...
//				'watermark_status'		=> CT_SNAPTRACK_WATERMARK_STATUS_DISABLE,
			...
			if(is_dir($user_folder_name)){
				...
				if (SHIN_Core::$_db[SHIN_Core::$_shdb->active_group]->trans_status() === FALSE)
				{
					...
					// send mail new user
					$mail1	= SHIN_Core::$_libs['mailer'];
					$mail1->Encoding = 'quoted-printable';
					
					$body	= $mail1->getFile("views/web/mails/for_user.tpl");
					
					$mail1->AddAddress(SHIN_Core::$_input->post('email'), 'New user');
					$mail1->Subject = SHIN_Core::$_language->line('lng_label_wauth');
					...
					$body	= str_replace('USERLAST', SHIN_Core::$_input->post('user-surname'), $body);
										
					$body	= str_replace('lng_label_site_description', SHIN_Core::$_language->line('lng_label_site_description'), $body);
					$body	= str_replace('lng_label_hello', SHIN_Core::$_language->line('lng_label_hello'), $body);
					$body	= str_replace('lng_label_new_user_trying_to_meetus', SHIN_Core::$_language->line('lng_label_new_user_trying_to_meetus'), $body);
					$body	= str_replace('lng_label_new_user_information', SHIN_Core::$_language->line('lng_label_new_user_information'), $body);
					$body	= str_replace('lng_label_yournickname', SHIN_Core::$_language->line('lng_label_yournickname'), $body);
					$body	= str_replace('lng_label_youremail', SHIN_Core::$_language->line('lng_label_youremail'), $body);
					$body	= str_replace('lng_label_yourpwd', SHIN_Core::$_language->line('lng_label_yourpwd'), $body);
					$body	= str_replace('lng_label_regards', SHIN_Core::$_language->line('lng_label_regards'), $body);
					$body	= str_replace('lng_label_if_not_for_admin', SHIN_Core::$_language->line('lng_label_if_not_for_admin'), $body);					
					
					$body	= str_replace('NICKNAME', $login, $body);
					$body	= str_replace('USER EMAIL', $mail, $body);
					$body	= str_replace('PWD', $pass, $body);
					$mail1->MsgHTML($body);
					...
					foreach ($query->result_array() as $row)
					{
						$mail2	= SHIN_Core::$_libs['mailer'];
						$mail2->Encoding = 'quoted-printable';
						$mail2->AddAddress($row['email'], 'For '.$row['name'].' '.$row['lastname']);
						
						$mail2->Subject = SHIN_Core::$_language->line('lng_label_new_user_appear');

						$body	= $mail2->getFile("views/web/mails/for_admin.tpl");
						
						$body	= str_replace('lng_label_site_description', SHIN_Core::$_language->line('lng_label_site_description'), $body);
						$body	= str_replace('lng_label_hello', SHIN_Core::$_language->line('lng_label_hello'), $body);
						$body	= str_replace('lng_label_new_user_trying_to_meetus', SHIN_Core::$_language->line('lng_label_new_user_trying_to_meetus'), $body);
						$body	= str_replace('lng_label_new_admin_information', SHIN_Core::$_language->line('lng_label_new_admin_information'), $body);
						$body	= str_replace('lng_label_yournickname', SHIN_Core::$_language->line('lng_label_yournickname'), $body);
						$body	= str_replace('lng_label_youremail', SHIN_Core::$_language->line('lng_label_youremail'), $body);
						$body	= str_replace('lng_label_yourpwd', SHIN_Core::$_language->line('lng_label_yourpwd'), $body);
						$body	= str_replace('lng_label_regards', SHIN_Core::$_language->line('lng_label_regards'), $body);
						...
						$body	= str_replace('lng_label_email', SHIN_Core::$_language->line('lng_label_email'), $body);
						$body	= str_replace('lng_label_lastname', SHIN_Core::$_language->line('lng_label_lastname'), $body);
						$body	= str_replace('lng_label_name', SHIN_Core::$_language->line('lng_label_name'), $body);						
						
												
						$body	= str_replace('ADMINF', $row['name'], $body);						
						$body	= str_replace('ADMINL', $row['lastname'], $body);						
						$body	= str_replace('USERNAME', $data['name'], $body);						
						$body	= str_replace('LASTNAME', $data['lastname'], $body);						
						$body	= str_replace('USER EMAIL', $data['email'], $body);
						$mail2->MsgHTML($body);
