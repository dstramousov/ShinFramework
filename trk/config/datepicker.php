...
$datepicker_ext['js'] = array(SHIN_Core::$_config['core']['shinfw_base_url'].'/'.SHIN_Core::$_config['core']['shinfw_folder'] . '/js/jquery/jquery.js', 
                              ...
                              SHIN_Core::$_config['core']['app_base_url']. '/js/maxzindex.js'
...
#$datepicker['beforeShow'] = 'function() {alert($(\'#ui-datepicker-div\').css("z-index")); $(\'#ui-datepicker-div\').css("z-index", 20);}';
