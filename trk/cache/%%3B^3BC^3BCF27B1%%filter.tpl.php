<?php /* Smarty version 2.6.26, created on 2011-09-12 07:47:26
         compiled from admin/image/filter.tpl */ ?>
<fieldset>
    <span style="color:red; font-weight:bold"><?php echo $this->_tpl_vars['lng_label_picture_filter']; ?>
:</span>
    <form>
    <?php echo $this->_tpl_vars['lng_label_current_user']; ?>
:
...
" <?php if ($this->_tpl_vars['user']['userId'] == $this->_tpl_vars['currentUser']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['user']['sys_user_username']; ?>
</option>
...
<?php endif; ?><?php echo '\');
        ...
        function makeSearch(){
            ...
            $.getJSON('; ?>
'<?php  echo base_url();  ?>/adminimage/setfilter'<?php echo ', {
                search: search        
            }, function(json) {
                if(json.result) {
        ...
        function resetSearch(){
            $.getJSON('; ?>
'<?php  echo base_url();  ?>/adminimage/resetfilter'<?php echo ', null, function(json) {
                pictureDataList.fnDraw();    
            })    
        }
