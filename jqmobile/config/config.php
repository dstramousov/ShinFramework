...
|
|	http://mywork/shinframework/jqmobile
|
*/
$config['core']['app_base_url']    = $config['core']['shinfw_base_url']."/jqmobile";
...
|--------------------------------------------------------------------------
*/
$config['theme']['default_theme'] = "lightness"; // "lightness", "redmond", "smoothness", "darkness" is also available
...
|--------------------------------------------------------------------------
*/
$config['gallery']['watermark_opacity'] = 70;
...
|--------------------------------------------------------------------------
*/
$config['gallery']['system_watermark'] = 'system_wt.jpg';
...
|--------------------------------------------------------------------------
*/
$config['gallery']['system_watermark_left'] = 'RIGHT';
...
|--------------------------------------------------------------------------
*/
$config['gallery']['system_watermark_top'] = 'BOTTOM';
...
|--------------------------------------------------------------------------
*/
$config['gallery']['max_upload_limit'] = 10;
...
|--------------------------------------------------------------------------
*/
$config['input']['item_per_page_values'] = array(6=>6,12=>12,18=>18, 24 => 24);
